(function () {
  ...
  const copy = {
    English: {
      ...
      successBody: "Thank you for registering for Bhagavad Gita Online Classes. Please join the WhatsApp group for more details - WhatsApp Group Link.",
    ...
    Telugu: {
      ...
      successBody: "Bhagavad Gita Online Classes కోసం నమోదు చేసినందుకు ధన్యవాదాలు. మరిన్ని వివరాల కోసం దయచేసి WhatsApp group లో చేరండి - WhatsApp Group Link.",
